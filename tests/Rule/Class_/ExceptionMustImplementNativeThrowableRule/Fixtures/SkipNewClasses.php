...
final class SkipNewClasses
{
    public function run(): void
    {
        new class(fake()->text()) extends NonImplementedNativeThrowableException implements ThrowableContract {};
        new class(fake()->text()) extends SkipImplementedNativeThrowableException {};
        new SkipImplementedNativeThrowableException(fake()->text());
        new SkipNonThrowableClass;
    }
}
